...
export default function CORNTEMPLATE({ hearts, time, setHearts, setTime, onDead, onPauseTimer }) {
    ...
    const getMutatedRegionCenter = () => {
      const mutatedRegion = document.querySelector(".cornmutated-region3");
    ...
    const checkIfNearCenter = () => {
      ...
      const draggable = document.querySelector(".grna9 div");
      if (!draggable) return;
  ...
  const checkIfNearCenterBox3 = () => { // Changed from checkIfNearCenterBox2 to checkIfNearCenterBox3
    ...
    const draggable = document.querySelector(".grna10 div"); // Changed from grna2 to grna10
    if (!draggable) return;
  ...
  const correctPosition = () => { 
    ...
    const box2 = document.querySelector(".grna8 div"); // Changed from grna6 to grna8
    if (!box2) return;
    const greenBox = box2.getBoundingClientRect();
    const container = document.querySelector(".grna8"); // Changed from grna6 to grna8
    if (!container) return;
        ...
        <div className='grna-container'>
                ...
                <div className='grna-container'>
                  <div className="grna10">
                    ...
                    dragMomentum={false}
                    >
                      5’-CTCAA CAACC_AAGTT TCCATGAG-3’
                    </motion.div>
                  </div>
                </div>

          <div className='corndna2'> 
