...
export default function EARTHGRNAEXP({hearts, time, setHearts, onDead, onPauseTimer, setTime}) {
    ...
    if (samStarted) {
        return <EARTHTEMPLATE hearts={hearts} time={time} setHearts={setHearts} onDead={onDead} onPauseTimer={onPauseTimer} setTime={setTime}/>;
      }
